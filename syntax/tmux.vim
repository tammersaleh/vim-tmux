...
syn keyword tmuxOptsSet status-right-fg update-environment base-index pane-base-index
...
syn keyword tmuxOptsSet mouse-select-pane mouse-resize-pane mouse-select-window message-limit quiet escape-time
